...
<li>
  <Link href="./week-8" className="font-bold text-pink-600 hover:text-pink-400 shadow-lg">
    Week 8
  </Link>
</li>
...
<li>
  <Link href="./week-10" className="font-bold text-pink-600 hover:text-pink-400 shadow-lg">
    Week 10
  </Link>
</li> 
